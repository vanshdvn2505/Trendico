...
function Cart() {
    ...
    const fetchCart = async () => {
        try {
            ...
            const response = await axios.post('http://localhost:7000/product/fetchCart', {userId});
    ...
    const removeFromCart = async (item) => {
        try {
            ...
            const id = item._id;
            const userId = auth.email;
            const response = await axios.post('http://localhost:7000/product/removeFromCart', {id, userId});
